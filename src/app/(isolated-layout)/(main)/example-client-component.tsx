...
export default function ExampleServerComponent() {
  ...
  const tourText = useLocalizedStringAlternate(stringCatalog, "tours", "_root/nav");
  const contactText = useLocalizedStringAlternate(stringCatalog, "contact_us", "_root/nav");
